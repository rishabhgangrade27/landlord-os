...
import { getActiveTenants } from './actions'
...
const NOTICE_TYPES = [
  ...
  { value: 'notice_7day',           label: '7-Day Non-Payment Notice (Court)' },
  { value: 'notice_14day',          label: '14-Day Non-Payment Notice (Court)' },
  { value: 'notice_30day',          label: 'Notice to Tenant (30-Day)' },
...
function GenerateNoticeContent() {
  ...
  useEffect(() => {
    getActiveTenants().then((data) => setTenants(data as TenantOption[]))
  }, [])
