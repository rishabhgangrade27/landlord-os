...
const NOTICE_LABELS: Record<string, string> = {
  ...
  notice_7day:           '7-Day Non-Payment (Court)',
  notice_14day:          '14-Day Non-Payment (Court)',
  notice_30day:          'Notice to Tenant (30-Day)',
...
export default async function LegalNoticesPage({
  ...
  const allNotices = await prisma.legalNotice.findMany({
    select: { status: true }
  })
  const counts = {
