...
import { getTenants, createManualTransactions } from './actions'
...
function ManualEntryContent() {
  ...
  useEffect(() => {
    getTenants().then((data) => setTenants(data as TenantOption[]))
  }, [])
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await createManualTransactions(insertRows)
