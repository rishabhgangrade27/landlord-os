...
export default function NewTenantPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { data, error } = await createTenant({
      ...
      // Leave it unset rather than faking a placeholder like "SYS-123456" —
      // that would look exactly like a real HRA case number to anyone
      // reading the record later. case_number is nullable and unique, and
