...
export default async function MaintenancePage() {
  const tickets = await prisma.maintenanceTicket.findMany({
    select: {
      id: true, title: true, category: true, priority: true, status: true, estimated_cost: true, actual_cost: true, created_at: true,
      property: { select: { name: true, nickname: true, address: true } },
